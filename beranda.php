    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong><center><marquee scrollamount = "20" behavior = "alternate" onmouseover = "this.stop()" onmouseout ="this.start()"> Selamat Datang di Dashboard STMIK Royal Kisaran</strong></marquee></center>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-warning">
                <div class="panel-heading">
                    <h3 class="panel-title"><center>Data Mahasiswa</h3></center>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th>Nim</th><th>Nama Mahasiswa</th><th>Kelas</th><th>Jurusan</th><th>Semester</th>
                            </tr>
                        </thead>
                        <tbody>
